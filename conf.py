...
# If DJANGO_MSAL_ALLOW_DJANGO_USERS is true:
#       allow authentication via Django for users that do not have MS account
DJANGO_MSAL_ALLOW_DJANGO_USERS = getattr(settings, 'DJANGO_MSAL_ALLOW_DJANGO_USERS', False)
